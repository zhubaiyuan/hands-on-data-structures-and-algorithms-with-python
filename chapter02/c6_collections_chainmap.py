...
defaults = {'theme': 'Default', 'language': 'eng',
            'showIndex': True, 'showFooter': True}
...
# returns the overridden theme
print("print value for a value theme is", cm2['theme'])
print("print the entry for 'theme' key", cm2.pop(
    'theme'))  # removes the child theme value
